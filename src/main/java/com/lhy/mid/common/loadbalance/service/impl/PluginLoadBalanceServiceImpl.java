package com.lhy.mid.common.loadbalance.service.impl;

import com.lhy.mid.common.loadbalance.entity.LBDto;
import com.lhy.mid.common.loadbalance.enums.LBTypeEnum;
import com.lhy.mid.common.loadbalance.lb.*;
import com.lhy.mid.common.loadbalance.service.PluginLoadBalanceService;
...
public class PluginLoadBalanceServiceImpl implements PluginLoadBalanceService {
     ...
     */
    @Override
    public LBDto lbSelect(@NonNull List<LBDto> lbDtos, @NonNull LBTypeEnum lbType, String hashArguments) {
